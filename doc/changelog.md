...
- `mix docs` configuration with grouped modules, the README and a sidecar
  operations guide as extras, and `llms.txt` output for LLM agents. The
  generated site (`doc/`) is committed and ships with the repository rather
  than being gitignored.
